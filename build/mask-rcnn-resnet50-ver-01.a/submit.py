...
with open('unpredicted_id', 'r') as f:
    ALL_TEST_IMAGE_ID = [line.strip() for line in f.readlines()]
...
#--------------------------------------------------------------
out_dir  = RESULTS_DIR + '/mask-rcnn-50-gray500-02-stage-2-unpredicted'
...
#         out_dir + '/checkpoint/00016500_model.pth'
    initial_checkpoint = \
    '/data/steeve/DSB/results/mask-rcnn-50-gray500-02/checkpoint/00016500_model.pth'
