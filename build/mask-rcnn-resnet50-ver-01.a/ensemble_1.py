...
out_dir = \
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray500-ensemble_mask-rcnn-50-resnext-gray553-stage2-ensemble/predict/out'
...
#         '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray500-aug/predict/v_flip',
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray500-ensemble/predict/r_270',
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray500-ensemble/predict/r_90',
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray500-ensemble/predict/h_flip',        
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray500-ensemble/predict/identity',  
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray553-stage2-ensemble/predict/identity',
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray553-stage2-ensemble/predict/v_flip',
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray553-stage2-ensemble/predict/h_flip',
        '/data/steeve/DSB/results/mask-rcnn-50-resnext-gray553-stage2-ensemble/predict/r_180',        
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-stage2-36k-stage2-ensemble/predict/identity',
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-stage2-36k-stage2-ensemble/predict/h_flip',
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-20.5k-stage2-ensemble/predict/identity',
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-20.5k-stage2-ensemble/predict/h_flip',
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-20.5k-stage2-ensemble/predict/r_270',        
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-stage2-36k-stage2-ensemble/predict/r_180',
#         '/data/steeve/DSB/results/mask-rcnn-resnext-50-color_external130-stage2-36k-stage2-ensemble/predict/r_270',        
...
def run_npy_to_sumbit_csv():
    ...
    csv_file = submit_dir + '/mask-rcnn-resnext-50-gray-extreme-ensemble-final.csv'
